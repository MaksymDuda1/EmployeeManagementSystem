/*
Deployment script for EmployeeManagementSystem
...
GO
:setvar DatabaseName "EmployeeManagementSystem"
:setvar DefaultFilePrefix "EmployeeManagementSystem"
...
GO
PRINT N'Creating Table [dbo].[EmployeeProject]...';
...
GO
PRINT N'Creating Table [dbo].[ProjectManager]...';
...
GO
PRINT N'Creating Default Constraint unnamed constraint on [dbo].[Manager]...';
...
GO
ALTER TABLE [dbo].[Employee]
    ADD FOREIGN KEY ([UserId]) REFERENCES [dbo].[AspNetUsers] ([Id]) ON DELETE CASCADE ON UPDATE CASCADE;


GO
PRINT N'Creating Foreign Key unnamed constraint on [dbo].[EmployeeProject]...';
...
GO
PRINT N'Creating Foreign Key unnamed constraint on [dbo].[Manager]...';
...
GO
PRINT N'Creating Foreign Key unnamed constraint on [dbo].[ProjectManager]...';


GO
ALTER TABLE [dbo].[ProjectManager]
    ADD FOREIGN KEY ([ManagerId]) REFERENCES [dbo].[Manager] ([Id]) ON DELETE CASCADE ON UPDATE CASCADE;
...
GO
ALTER TABLE [dbo].[ProjectManager]
    ADD FOREIGN KEY ([ProjectId]) REFERENCES [dbo].[Project] ([Id]) ON DELETE CASCADE ON UPDATE CASCADE;


GO
PRINT N'Creating Foreign Key unnamed constraint on [dbo].[Task]...';


GO
ALTER TABLE [dbo].[Task]
    ADD FOREIGN KEY ([EmployeeId]) REFERENCES [dbo].[Employee] ([Id]) ON DELETE CASCADE ON UPDATE CASCADE;
